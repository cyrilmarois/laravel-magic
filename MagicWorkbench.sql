...
CREATE TABLE IF NOT EXISTS `MagicWorkbench`.`set` (
  ...
  PRIMARY KEY (`id`),
  INDEX `set_collection_id_idx` (`collection_id` ASC),
...
-- -----------------------------------------------------
-- Table `MagicWorkbench`.`deck_card`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MagicWorkbench`.`deck_card` (
...
CREATE TABLE IF NOT EXISTS `MagicWorkbench`.`card_content` (
  ...
  `card_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `card_content_language_id_idx` (`language_id` ASC),
  INDEX `card_content_card_id_idx` (`card_id` ASC),
  CONSTRAINT `card_content_language_id_foreign`
